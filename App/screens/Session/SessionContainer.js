        ...
        <View>
          ...
          >
            <View style={styles.presentContainer}>
              ...
              />
              <Text style={styles.presentText}>{speaker && speaker.name}</Text>
            </View>
          </TouchableOpacity>
        </View>
        <View>
          {findArray.find(id => id.id === faveid) ? (
            <LinearGradient
              ...
              style={{
                ...Platform.select({
                  ...
                  ios: { flex: 1, paddingVertical: 5, paddingHorizontal: 5 }
                })
              }}
            >
              <TouchableOpacity
              ...
              >
                <Text style={styles.gradientText}>Delete from Faves</Text>
              </TouchableOpacity>
            </LinearGradient>
          ) : (
            <LinearGradient
            ...
            >
              ...
              >
                <Text style={styles.gradientText}>Add to Faves</Text>
              </TouchableOpacity>
            </LinearGradient>
          )}
        </View>
